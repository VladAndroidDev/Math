...
class HistoryAdapter(private val list:List<History>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is HistoryViewHolder) {
            ...
            val quality = "${correctAnswers.toDouble()/totalTasks}%"
            ...
            val headerItem = HeaderItemHistoryList(timeStr, totalTasks.toString(),correctAnswers.toString(),quality)
    ...
    class HeaderHistoryViewHolder(private val binding: HeaderHistoryBinding):RecyclerView.ViewHolder(binding.root){
        fun bind(item:HeaderItemHistoryList){
            binding.item =item
        }
    }
}
class HeaderItemHistoryList(val timeInGame:String,val totalTasks:String,val correctAnswers:String,val quality:String)
